...
public:
    ...
    GLuint getUniformLocation(char* variableName) const; //Pobiera numer slotu zwi¹zanego z dan¹ zmienn¹ jednorodn¹
    GLuint getAttribLocation(char* variableName) const; //Pobiera numer slotu zwi¹zanego z danym atrybutem
};
